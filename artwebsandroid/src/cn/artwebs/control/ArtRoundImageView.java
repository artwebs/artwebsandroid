...
public class ArtRoundImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ArtRoundImageView);
            roundWidth= a.getDimensionPixelSize(R.styleable.ArtRoundImageView_roundWidth, roundWidth);
            roundHeight= a.getDimensionPixelSize(R.styleable.ArtRoundImageView_roundHeight, roundHeight);
        }else {
