...
import com.artwebsandroid.utils.Base64;
import com.artwebsandroid.utils.CnToSpell;
...
public class LHB {
	...
	public String Base64Decode(String para) {
	   ...
	   public String getNowStr(String type){
		      ...
		      String year = this.GetEnoughLenStr(4, ""+ca.get(Calendar.YEAR));//获取年份 
		      String month=this.GetEnoughLenStr(2, ""+(ca.get(Calendar.MONTH)+1));//获取月份  
		      String day=this.GetEnoughLenStr(2, ""+ca.get(Calendar.DATE));//获取日 
		      String minute=this.GetEnoughLenStr(2, ""+ca.get(Calendar.MINUTE));//分  
		      String hour=this.GetEnoughLenStr(2, ""+ca.get(Calendar.HOUR_OF_DAY));//小时  
		      String second=this.GetEnoughLenStr(2, ""+ca.get(Calendar.SECOND));//秒 
